...
public class TriangleTest {
  ...
  private static Logger logger = LoggerFactory.getLogger(TriangleTest.class);
    ...
    void areaIsRoundNumber(){
      assertEquals(6, Lesson_4.Triangle.AreaTriangle(3, 4, 5));
    }

    @Test
    @DisplayName("Площадь треугольника нецелое число")
    void areaIsDoubleNumber(){
        assertEquals( 3.799671038392666, Lesson_4.Triangle.AreaTriangle(2,4,5));
    }
    ...
    void areaIsDoubleNumber2(double a, double b, double c, double result){
        assertEquals(result, Lesson_4.Triangle.AreaTriangle(a, b, c));
    }
    ...
    assertAll(
            () -> Lesson_4.Triangle.AreaTriangle(0, 2, 4),
            () -> Lesson_4.Triangle.AreaTriangle(2, 0, 4),
            () -> Lesson_4.Triangle.AreaTriangle(2,4, 0),
            () -> Lesson_4.Triangle.AreaTriangle(-1,4, 2),
            () -> Lesson_4.Triangle.AreaTriangle(2,-1, 4),
            () -> Lesson_4.Triangle.AreaTriangle(2,4, -1)
    );
    }
    @Test
    ...
    void isNotTriangle(){
        assertAll(
                ()-> Lesson_4.Triangle.AreaTriangle(2, 1, 1),
                ()-> Lesson_4.Triangle.AreaTriangle(8, 1, 7),
